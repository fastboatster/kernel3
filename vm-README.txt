...
Comments : Tests in Part C,D,E is not working
...
Comments: Please run Part B from kshell.

(C.1) /usr/bin/segfault (0 out of 1 pt)

(D.2) /usr/bin/vfstest (0 out of 7 pts)
(D.3) /usr/bin/memtest (0 out of 7 pts)
(D.4) /usr/bin/eatmem (0 out of 7 pts)
...
(F) Self-checks: (10 out of 10 pts)
    Comments: All code paths have been tested
...
Use dbg_print(...) instead of dbg(DBG_PRINT, ...) : No_where
...
Compiler warnings : 3 warnings
"make clean" : works
Useless KASSERT : None	
Insufficient/Confusing dbg : None
Kernel panic : Yes
Cannot halt kernel cleanly : It's not halting cleanly

+------+
| BUGS |
+------+

Comments: Ref Count is not zero and user shell is not being created.
